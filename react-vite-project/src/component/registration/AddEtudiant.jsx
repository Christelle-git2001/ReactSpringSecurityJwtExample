...
function AddEtudiant(props) {
  ...
  const fields = [
    ...
    { name: "matricule", labelKey: "matricule", minLength: "7", maxLength: "7" },
    {
      name: "department",
      labelKey: "department",
      type: "select",
  ...
  return <RegisterForm translationPrefix="add_etudiant" fields={fields} {...props} />;
}
